...
> ⚠️ **本文件是 2026-09-01 的历史快照，其中的「待运维执行 / 未部署」项后来都已闭环**（2026-09-02：题库重建 SQL 已执行并回归通过、四修复随发版上正式；2026-09-03：6a789c4 上正式）。**当前状态请看 [[session-handoff-2026-09-18-prod-500-and-copy-fix-verified]]（新 session 先读）**。
