...
> **⚠️ 本节数字已被取代（2026-09-22 晚）**：本节写于第七次重打时点。此后又发生**第八次重打**（PPT 去自损表述改版：封面/P2 删弱项定性、P8 改正面口径、P10 边界页整页删、附录 A 改"三个坑与三个修复"，**13 页 → 12 页 = 10 主讲 + 2 附录**）→ 源码包 **9,138,208 B / `97596585…` / 86 条目**、PPT 两版 **779,512 / 779,528 B**、`说明.md` **3,490 B**、`交付清单-SHA256.txt` **11,737 B / md5 `d9a639a3…`**；镜像 tar `8c2668ac…` 未变。**本节 23.6 的表只作史料**，现值一律以 [[session-handoff-3d-2026-09-22-pm]] §八 与 [[文本生成3D方案赛-主索引]] 首条为准。另：**FDM 实物已定稿只打 `hid_con_005` 一件**（09-22 用户裁定，见同处 §八 与 [[官方要求核对与缺口清单-20260921]] §十之二）。
