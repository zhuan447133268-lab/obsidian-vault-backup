...
> **🏷️ 2026-09-08 最新状态（v7 定稿）**：v5=89.9675/55 名。丢分解剖确认：触发率天花板 80%（理解类不触发），主失分 = 3 道零分题 + 每题质量分。参照 anthropics/skills 官方准则完成 v7.0.0：PPT 去 AI 模板化（禁色条/下划线）+大数字 KPI 页+图表数据标签、Word 页码、Excel 公式错误兜底+函数白名单、四 builder 重开自检。**9/9 提交 dist/dumate-bdci_skills_v7.zip**。详见 §4 v7 与 HANDOFF §16。
